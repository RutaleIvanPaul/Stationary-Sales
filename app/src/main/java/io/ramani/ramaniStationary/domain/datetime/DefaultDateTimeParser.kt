...
class DefaultDateTimeParser(private val dateTimeManager: IDateTimeManager) : DateTimeParser {
    ...
    companion object {
        ...
        private const val SERVER_SEND_DATE_TIME_FORMAT = "MM-dd-yyyy'T'HH:mm:ss.SSS'Z'"
    ...
    override fun convertToServerDate(date: Long): String? =
        formatToDateString(date, SERVER_SEND_DATE_FORMAT)

    override fun convertToServerDashedDate(date: Long): String? =
        formatToDateString(date, SERVER_SEND_DATE_TIME_FORMAT)

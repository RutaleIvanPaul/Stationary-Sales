package io.ramani.ramaniStationary.domain.entities.exceptions

import android.util.Log
import io.ramani.ramaniStationary.domain.entities.ValidationErrorRemote
...
class ValidationErrorsException(
    message: String? = "",
    val validationErrors: List<ValidationErrorRemote>
) : Exception(message) {

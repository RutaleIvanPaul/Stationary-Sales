...
import io.ramani.ramaniStationary.data.common.network.HeadersProvider
import io.ramani.ramaniStationary.domain.datetime.DateFormatter
import java.io.File


class DownloadManager(
    private val context: Context, var dateFormatter: DateFormatter,
    private val headersProvider: HeadersProvider
) : IMediaDownloadManager {

    var downloadManager = context.getSystemService(DOWNLOAD_SERVICE) as DownloadManager

    override fun enqueue(
        downloadUrl: String, mediaType: Int, fileName: String, needsAuth: Boolean,

package io.ramani.ramaniStationary.data.common.source.remote
...
import io.ramani.ramaniStationary.domain.entities.ValidationErrorsResponse
...
import io.ramani.ramaniStationary.domain.entities.exceptions.UnknownNetworkError
import io.ramani.ramaniStationary.domain.entities.exceptions.ValidationErrorsException
import io.ramani.ramaniStationary.domainCore.log.logError
    ...
    private fun handleErrorInternal(throwable: Throwable): Throwable {
        ...
        error = if (throwable is HttpException) {
            ...
            when (code) {
                ...
                ErrorConstants.INPUT_VALIDATION_400, ErrorConstants.UNPROCESSABLE_ENTITY_422 -> getValidationError(
                    throwable
                )?.let {
